"""
# Ejercicio 3:
Sabiendo que la tarifa de taxi de una ciudad es 2,5 € por el inicio del servicio mas 46 centimos
de euro por cada 400 metros de recorrido. Crea una función que devuelva el precio de una
carrera indicando los kilómetros (no los metros) recorridos.
Si se informa una distancia recorrida menor que cero, la función debe devolver el valor -1
(indicativo de error)
